...
int main() {
    ...
    cout << "[*] Firing " << towers << " Asynchronous CUDA Streams via C++ HAL..." << endl;
    ...
    cout << "[+] Hardware Execution Time: " << elapsed.count() << " ms" << endl;
    ...
    if (expected == host_res[0]) {
        cout << "\n[SUCCESS] GPU HAL verified — memory pointers and grid-stride logic correct." << endl;
    } else {
