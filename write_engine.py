with open('src/main_gpu_engine.cpp', 'w') as f:
    f.write("""#include "cuda_hal.h"
#include <iostream>
#include <vector>
...
if "add_executable(gpu_engine" not in content:
    with open('CMakeLists.txt', 'a') as f:
        f.write("\nadd_executable(gpu_engine src/main_gpu_engine.cpp)\n")
        f.write("target_link_libraries(gpu_engine PRIVATE openfhe_cuda_hal CUDA::cudart)\n")
